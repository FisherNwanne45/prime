                ...
                <section class="management-hierarchy">
                    <div class="hv-container">
                        <div class="hv-wrapper">
                            <!-- tree component -->
                            @include('frontend::referral.include.__tree',['levelUser' => auth()->user(),'level' =>
                            $level,'depth' => 1, 'me' => true])
                        </div>
                    </div>
                </section>
                @endif
        ...
        <div class="site-card">
            <div class="site-card-header">
                ...
                <div class="card-header-links">
                    <span class="card-header-link rounded-pill">
                        {{ __('Referral Profit:').' '. $totalReferralProfit .' '.$currency }}</span>
                </div>
            </div>
            <div class="site-card-body table-responsive">
                    ...
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a href="" class="nav-link active" id="generalTarget-tab" data-bs-toggle="pill"
                                ...
                                aria-selected="true"><i icon-name="network"></i>{{ __('General') }}</a>
                        </li>
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="" class="nav-link" id="t{{ $target['id'] }}-tab" data-bs-toggle="pill"
                                data-bs-target="#t{{ $target['id'] }}" type="button" role="tab"
                                aria-controls="t{{ $target['id'] }}" aria-selected="true"><i icon-name="boxes"></i>
                ...
                <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <table class="display data-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><strong
                                                                class="green-color">+{{ $raw->amount.' '. $currency }}
                                                            </strong>
                                                        </td>
                                                        <td>
                                        ...
                                        <div class="single-transaction">
                                            <div class="transaction-left">
                                                <div class="transaction-des">
                                                    <div class="transaction-title">{{ $raw->description }}</div>
                    ...
                    <div class="tab-pane fade" id="t{{ $target['id'] }}" role="tabpanel"
                                            ...
                                            <table class="display data-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><strong>{{$raw->tnx}}</strong></td>
                                                        <td>
                                                            <div class="site-badge primary-bg">{{ $raw->target_type }}
                                                            </div>
                                                        </td>
                                                        <td><strong
                                                                class="green-color">+{{ $raw->amount.' '. $currency }}
                                    ...
                                    <div class="contents">
                                        ...
                                        <div class="single-transaction">
                                            ...
                                            <div class="transaction-right">
                                                <div class="transaction-amount add">
                                                    +{{$raw->amount .' '.$currency}}</div>
                                                <div class="transaction-gateway"> {{ $raw->target_type }}</div>
