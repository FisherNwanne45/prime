<div class="col-xl-6 col-lg-12 col-md-12 col-12">
    <div class="site-card">
        ...
        <div class="site-card-body">
            ...
            <p class="paragraph mb-4"><i icon-name="alert-triangle"></i><strong>Warning:</strong> Once you
                ...
                <div class="col-sm-8">
                    <div class="form-switch ps-0">
                        ...
                        <div class="switch-field same-type m-0">
                            <input type="radio" id="{{$field['name'] . $key}}" name="{{$field['name']}}" value="1"
                                @if(oldSetting($field['name'],$section)) checked @endif />
                            <label for="{{$field['name'] . $key}}">{{ __('Enable') }}</label>
                            <input type="radio" id="disable-{{$field['name'] . $key}}" name="{{$field['name']}}"
            ...
            <div class="site-input-groups row">
                ...
                <div class="col-sm-8">
                    <input type="{{$field['type']}}" name="{{ $field['name'] }}"
                        class="box-input @if($errors->has($field['name'])) has-error @endif" placeholder="Label"
